...
@NamedQueries({
    ...
    @NamedQuery(name = "User_1.findByHost", query = "SELECT u FROM User_1 u WHERE u.userPK.host = :host"),
    @NamedQuery(name = "User_1.findByUser", query = "SELECT u FROM User_1 u WHERE u.userPK.user = :user"),
    @NamedQuery(name = "User_1.findByPassword", query = "SELECT u FROM User_1 u WHERE u.password = :password"),
    @NamedQuery(name = "User_1.findBySelectpriv", query = "SELECT u FROM User_1 u WHERE u.selectpriv = :selectpriv"),
    @NamedQuery(name = "User_1.findByInsertpriv", query = "SELECT u FROM User_1 u WHERE u.insertpriv = :insertpriv"),
    @NamedQuery(name = "User_1.findByUpdatepriv", query = "SELECT u FROM User_1 u WHERE u.updatepriv = :updatepriv"),
    @NamedQuery(name = "User_1.findByDeletepriv", query = "SELECT u FROM User_1 u WHERE u.deletepriv = :deletepriv"),
    @NamedQuery(name = "User_1.findByCreatepriv", query = "SELECT u FROM User_1 u WHERE u.createpriv = :createpriv"),
    @NamedQuery(name = "User_1.findByDroppriv", query = "SELECT u FROM User_1 u WHERE u.droppriv = :droppriv"),
    @NamedQuery(name = "User_1.findByReloadpriv", query = "SELECT u FROM User_1 u WHERE u.reloadpriv = :reloadpriv"),
    @NamedQuery(name = "User_1.findByShutdownpriv", query = "SELECT u FROM User_1 u WHERE u.shutdownpriv = :shutdownpriv"),
    @NamedQuery(name = "User_1.findByProcesspriv", query = "SELECT u FROM User_1 u WHERE u.processpriv = :processpriv"),
    @NamedQuery(name = "User_1.findByFilepriv", query = "SELECT u FROM User_1 u WHERE u.filepriv = :filepriv"),
    @NamedQuery(name = "User_1.findByGrantpriv", query = "SELECT u FROM User_1 u WHERE u.grantpriv = :grantpriv"),
    @NamedQuery(name = "User_1.findByReferencespriv", query = "SELECT u FROM User_1 u WHERE u.referencespriv = :referencespriv"),
    @NamedQuery(name = "User_1.findByIndexpriv", query = "SELECT u FROM User_1 u WHERE u.indexpriv = :indexpriv"),
    @NamedQuery(name = "User_1.findByAlterpriv", query = "SELECT u FROM User_1 u WHERE u.alterpriv = :alterpriv"),
    @NamedQuery(name = "User_1.findByShowdbpriv", query = "SELECT u FROM User_1 u WHERE u.showdbpriv = :showdbpriv"),
    @NamedQuery(name = "User_1.findBySuperpriv", query = "SELECT u FROM User_1 u WHERE u.superpriv = :superpriv"),
    @NamedQuery(name = "User_1.findByCreatetmptablepriv", query = "SELECT u FROM User_1 u WHERE u.createtmptablepriv = :createtmptablepriv"),
    @NamedQuery(name = "User_1.findByLocktablespriv", query = "SELECT u FROM User_1 u WHERE u.locktablespriv = :locktablespriv"),
    @NamedQuery(name = "User_1.findByExecutepriv", query = "SELECT u FROM User_1 u WHERE u.executepriv = :executepriv"),
    @NamedQuery(name = "User_1.findByReplslavepriv", query = "SELECT u FROM User_1 u WHERE u.replslavepriv = :replslavepriv"),
    @NamedQuery(name = "User_1.findByReplclientpriv", query = "SELECT u FROM User_1 u WHERE u.replclientpriv = :replclientpriv"),
    @NamedQuery(name = "User_1.findByCreateviewpriv", query = "SELECT u FROM User_1 u WHERE u.createviewpriv = :createviewpriv"),
    @NamedQuery(name = "User_1.findByShowviewpriv", query = "SELECT u FROM User_1 u WHERE u.showviewpriv = :showviewpriv"),
    @NamedQuery(name = "User_1.findByCreateroutinepriv", query = "SELECT u FROM User_1 u WHERE u.createroutinepriv = :createroutinepriv"),
    @NamedQuery(name = "User_1.findByAlterroutinepriv", query = "SELECT u FROM User_1 u WHERE u.alterroutinepriv = :alterroutinepriv"),
    @NamedQuery(name = "User_1.findByCreateuserpriv", query = "SELECT u FROM User_1 u WHERE u.createuserpriv = :createuserpriv"),
    @NamedQuery(name = "User_1.findByEventpriv", query = "SELECT u FROM User_1 u WHERE u.eventpriv = :eventpriv"),
    @NamedQuery(name = "User_1.findByTriggerpriv", query = "SELECT u FROM User_1 u WHERE u.triggerpriv = :triggerpriv"),
    @NamedQuery(name = "User_1.findByCreatetablespacepriv", query = "SELECT u FROM User_1 u WHERE u.createtablespacepriv = :createtablespacepriv"),
    @NamedQuery(name = "User_1.findBySslType", query = "SELECT u FROM User_1 u WHERE u.sslType = :sslType"),
    @NamedQuery(name = "User_1.findByMaxQuestions", query = "SELECT u FROM User_1 u WHERE u.maxQuestions = :maxQuestions"),
    @NamedQuery(name = "User_1.findByMaxUpdates", query = "SELECT u FROM User_1 u WHERE u.maxUpdates = :maxUpdates"),
    @NamedQuery(name = "User_1.findByMaxConnections", query = "SELECT u FROM User_1 u WHERE u.maxConnections = :maxConnections"),
    @NamedQuery(name = "User_1.findByMaxUserConnections", query = "SELECT u FROM User_1 u WHERE u.maxUserConnections = :maxUserConnections"),
    @NamedQuery(name = "User_1.findByPlugin", query = "SELECT u FROM User_1 u WHERE u.plugin = :plugin")})
public class User_1 implements Serializable {
    ...
    public User_1(String host, String user) {
    ...
    public String toString() {
        return "Interface.User_1[ userPK=" + userPK + " ]";
    }
